...
- `esp32-dev-oled-ultra-safe` pour le diagnostic SD approfondi sur ESP32 Dev Module
- `esp32-dev-oled-hspi-debug` pour le diagnostic SD fallback HSPI sur ESP32 Dev Module
