...
3. Sélectionner l’environnement PlatformIO : `esp32-s3-oled` (ESP32-S3 DevKitC-1), `esp32-dev-oled` (ESP32 Dev Module), ou `esp32-dev-oled-ultra-safe` (debug SD ESP32 Dev Module).
