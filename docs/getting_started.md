...
3. Select PlatformIO environment: `esp32-s3-oled` (ESP32-S3 DevKitC-1), `esp32-dev-oled` (ESP32 Dev Module), or `esp32-dev-oled-ultra-safe` (ESP32 Dev Module SD debug).
