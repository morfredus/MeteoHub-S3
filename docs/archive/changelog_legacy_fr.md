...
- **Documentation** : Guides utilisateur (EN/FR) mis à jour pour expliquer le nouveau nommage OLED et le support d'affichage UTF-8. Version minimale valide portée à 1.0.165.
