# [1.0.178] – 2026-03-05
- Added configurable SD bus mode (`SD_BUS_MODE`) with values: AUTO (SPI→SDIO), SPI-only, SDIO-only.
- Set current board configuration to SPI-only mode to avoid repeated SDIO fallback attempts on SPI-wired modules.
