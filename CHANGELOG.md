# [1.0.182] – 2026-03-03
- Added support for the new 3.3V SD module with SPI as primary mode and SD_MMC 1-bit as fallback.
- Updated SD manager to expose active filesystem/mode and migrated history/web/system info to use the selected SD backend.
- Updated hardware wiring docs for pins: CLK, D0/SO, CMD/SI, D3/CS, D1, DAT2, DET4.
- Minimum valid version: 1.0.182

# [1.0.181] – 2026-03-03
- Fixed web file manager build errors after SD_MMC migration by replacing remaining `SD` references with `SD_MMC` in `web_manager.cpp`.
