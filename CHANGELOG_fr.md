# [1.0.182] – 2026-03-03
- Ajout du support du nouveau module SD 3.3V avec SPI en mode principal et SD_MMC 1-bit en mode de repli.
- Mise à jour du gestionnaire SD pour exposer le FS/mode actif et migration de history/web/system info vers le backend SD sélectionné.
- Mise à jour de la documentation de câblage pour les broches : CLK, D0/SO, CMD/SI, D3/CS, D1, DAT2, DET4.
- Version minimale valide : 1.0.182

# [1.0.181] – 2026-03-03
- Correction des erreurs de compilation du gestionnaire de fichiers web après migration SD_MMC en remplaçant les références restantes à `SD` par `SD_MMC` dans `web_manager.cpp`.
