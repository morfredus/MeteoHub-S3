# [1.0.178] – 2026-03-05
- Ajout d'un mode de bus SD configurable (`SD_BUS_MODE`) avec les valeurs : AUTO (SPI→SDIO), SPI-only, SDIO-only.
- Configuration actuelle de la carte positionnée en mode SPI-only pour éviter les tentatives SDIO répétées sur les modules câblés en SPI.
