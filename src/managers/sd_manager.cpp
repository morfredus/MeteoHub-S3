...
#ifndef SD_BUS_MODE_AUTO
#define SD_BUS_MODE_AUTO 0
#endif
#ifndef SD_BUS_MODE_SPI_ONLY
#define SD_BUS_MODE_SPI_ONLY 1
#endif
#ifndef SD_BUS_MODE_SDIO_ONLY
#define SD_BUS_MODE_SDIO_ONLY 2
#endif
#ifndef SD_BUS_MODE
#define SD_BUS_MODE SD_BUS_MODE_AUTO
#endif
...
bool SdManager::mountWithRetries() {
    ...
    const bool allow_spi = (SD_BUS_MODE == SD_BUS_MODE_AUTO) ||
                           (SD_BUS_MODE == SD_BUS_MODE_SPI_ONLY);
    const bool allow_sdio = (SD_BUS_MODE == SD_BUS_MODE_AUTO) ||
                            (SD_BUS_MODE == SD_BUS_MODE_SDIO_ONLY);
